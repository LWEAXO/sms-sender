...
async function smsBomber(phone, amount) {
    ...
    console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) + chalk.greenBright("[Sms Bomb]") + chalk.blueBright(` ${phone} `.yellow.bold +` numarasına `.cyan.bold+ `${amount}`.yellow +` adet sms gönderiliyor.`.cyan.bold));
    const queryPromise = new Promise(async (resolve, reject) => {
        try {
            let dataSb = {
                startDate: Date.now(),
                phone: phone,
                amount: amount,//lweaxo
                total: 0,
                success: 0,
                error: 0,
            };
            ...
            async function kigili(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 202) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Kigili]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Kigili]") +
            ...
            async function kahvedunyasi(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [KahveDünyası]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [KahveDünyası]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            async function wmf(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 202) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [WMF]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [WMF]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            async function tiklagelsin(no) {
                ...
                request({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [TiklaGelsin]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [TiklaGelsin]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function bim(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Bim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Bim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function sok(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Sok]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Sok]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function migros(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Migros]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Migros]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function a101(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [A101]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [A101]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function sakasu(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Sakasu]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Sakasu]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });     
            }
            ...
            function zarinplus(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [ZarinPlus]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [ZarinPlus]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }//lweaxo
            ...
            function coregap(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {//lweaxo
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [CoreGap]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [CoreGap]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function icq(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [ICQ]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [ICQ]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                }
                });
            ...
            function naosstars(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [NaosStars]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [NaosStars]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function rentiva(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Rentiva]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Rentiva]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            async function loncamarket(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [LoncaMarket]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [LoncaMarket]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function kimgb(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Kimgb]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Kimgb]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function tazi(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Tazi]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Tazi]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function evidea(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Evidea]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Evidea]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function heyscooter(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [HeyScooter]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [HeyScooter]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function koton(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200 || httpResponse?.statusCode == 201 || httpResponse?.statusCode == 202 || httpResponse?.statusCode == 204 || httpResponse?.statusCode == 205) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Koton]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Koton]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function ipragaz(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Ipragaz]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Ipragaz]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function metro(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Metro]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Metro]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function happy(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Happy]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Happy]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function komagene(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Komagene]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Komagene]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function kuryemgelsin(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [KuryemGelsin]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [KuryemGelsin]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function taksim(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Taksim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Taksim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function toptanteslim(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [ToptanTeslim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [ToptanTeslim]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function starbucks(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Starbucks]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Starbucks]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            } 
            ...
            function baydöner(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [BayDöner]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [BayDöner]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
                ...
                function pidem(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [Pidem]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [Pidem]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
                ...
                function bodrumbelediyesi(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [BodrumBelediyesi]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [BodrumBelediyesi]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
            ...
            function frink(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Fring]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Fring]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
            ...
            function dominos(no) {
                ...
                request.post({
                    ...
                    if (httpResponse?.statusCode == 200) {
                        dataSb.success++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.greenBright("Sms Bomb | [Dominos]") +
                            chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                    } else {
                        dataSb.error++;
                        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                            chalk.redBright("Sms Bomb | [Dominos]") +
                            chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                    }
                });
            }
                ...
                function yapp(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [Yapp]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [Yapp]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
                ...
                function porty(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [Porty]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [Porty]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
                ...
                function clickme(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [Clickme]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [Clickme]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
                ...
                function akbati(no) {
                    ...
                    request.post({
                        ...
                        if (httpResponse?.statusCode == 200) {
                            dataSb.success++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.greenBright("Sms Bomb | [Akbati]") +
                                chalk.blueBright(` ${no} numarasına sms gönderildi.`));
                        } else {
                            dataSb.error++;
                            console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                                chalk.redBright("Sms Bomb | [Akbati]") +
                                chalk.blueBright(` ${no} numarasına sms gönderilemedi.`));
                        }
                    });
                }
            ...
            async function systemFinished() {
                ...
                console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) +
                    chalk.greenBright("Sms Bomb") +
                    chalk.blueBright(` Toplamda`.cyan.bold + ` ${dataSb.total}`.green.bold + ` adet sms gönderildi.`.cyan.bold + ` (`.cyan.bold + `${dataSb.success}`.green.bold + ` başarılı,`.cyan.bold + ` ${dataSb.error}`.red.bold + ` hatalı)`.cyan.bold));
    ...
    if (result.status) {
        console.log(chalk.gray(`[${dayjs().format("YYYY-MM-DD HH:mm:ss")}] `.white + `> `.grey) + chalk.greenBright("Sms Bomb") + chalk.blueBright(` ${phone}`.yellow.bold + ` numarasına `.cyan.bold + `${amount}`.green.bold + ` adet sms gönderildi.`.cyan.bold));
